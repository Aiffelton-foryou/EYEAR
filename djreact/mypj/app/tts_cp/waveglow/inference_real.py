...
## 체크포인트 설정
tacotron2_checkpoint = 'C:/Users/금정산1_PC15/Desktop/workspace/waveglow/tacotron2/output/v100_checkpoint_336000'
waveglow_checkpoint = 'C:/Users/금정산1_PC15/Desktop/workspace/waveglow/checkpoints/v100_waveglow_348000'
...
## 음성 저장하기
sf.write('문장_돌고래.wav', audio, sampling_rate)

## 문장 생성
sample_text = '용돈을 아껴 써라.'
audio, sampling_rate = synthesizer.inference(sample_text)
## 음성 저장하기
sf.write('문장_용돈.wav', audio, sampling_rate)