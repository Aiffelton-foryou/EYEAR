...
## 체크포인트 설정
tacotron2_checkpoint = 'C:/Users/금정산1_PC15/Desktop/workspace/waveglow/tacotron2/output/gcp_checkpoint_90000'
waveglow_checkpoint = 'C:/Users/금정산1_PC15/Desktop/workspace/waveglow/checkpoints/waveglow_249000'
...
## 음성 저장하기
sf.write('w1t1_문장_0526_돌고래.wav', audio, sampling_rate)
#돌고래 : 돌고래는 지능이 발달했다.
#용돈 : 용돈을 아껴 써라.
## 구문 생성
sample_phrase = """
...
## 음성 저장하기
sf.write('w1t1_sample_phrase.wav', audio, sampling_rate)
## 문장 생성
sample_text = '용돈을 아껴 써라.'
audio, sampling_rate = synthesizer.inference(sample_text)
## 음성 저장하기
sf.write('w1t1_문장_0526_용돈.wav', audio, sampling_rate)
#돌고래 : 돌고래는 지능이 발달했다.
#용돈 : 용돈을 아껴 써라.
sample_text = '하이 빅스비.'
audio, sampling_rate = synthesizer.inference(sample_text)
## 음성 저장하기
sf.write('w1t1_빅스비.wav', audio, sampling_rate)
## 구문 생성
sample_phrase = """
타코트론 모델은 음성 생성 길이가 제한되어 있습니다.
즉 구문을 구성하려면 여러개의 문장을 생성한 후 합쳐야 합니다.
